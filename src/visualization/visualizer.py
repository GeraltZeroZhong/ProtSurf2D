...
import os
import re
from src.interactions.interaction_engine import load_prolif_data

logger = logging.getLogger("Visualizer")

class InterfaceVisualizer:
    def __init__(self, chain_A_atoms, chain_A_coords, chain_B_coords, chain_B_atoms=None, 
                 pdb_file=None, chain_a_id=None, chain_b_id=None, prolif_file=None):
        """
        Args:
    ...
    def _get_interaction_type_heuristic(self, atom_A, atom_B, dist):
        ...
        if dist < 5.0:
            if dist < 4.0 and ((is_cat_A and is_ani_B) or (is_ani_A and is_cat_B)): return 'Cationic'
