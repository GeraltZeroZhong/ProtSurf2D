...
class UIMixin:
    def _init_controls(self):
        ...
        self.entry_chain_a.insert(0, DEFAULT_RUN_CONFIG.chain_a)
        ...
        self.entry_chain_b.insert(0, DEFAULT_RUN_CONFIG.chain_b)
        ...
        self.entry_cutoff.insert(0, str(DEFAULT_RUN_CONFIG.topology.distance_cutoff))
        ...
        self.entry_res.insert(0, str(DEFAULT_RUN_CONFIG.surface.grid_resolution))
        ...
        self.entry_sigma.insert(0, str(DEFAULT_RUN_CONFIG.surface.sigma))
        ...
        self.var_filter_valid_only = tk.BooleanVar(value=self.config.filter_valid_only)
        ...
        self.entry_optcuts_bin.insert(0, DEFAULT_RUN_CONFIG.optcuts.optcuts_bin)
        ...
        self.entry_optcuts_frame_stride.insert(0, str(DEFAULT_RUN_CONFIG.optcuts.optcuts_frame_stride))
        ...
        self.entry_optcuts_min_frame_long_edge.insert(0, str(DEFAULT_RUN_CONFIG.optcuts.optcuts_min_frame_long_edge))
    ...
    def start_analysis(self):
        ...
        params = {
            ...
            'optcuts_frame_stride': int(self.entry_optcuts_frame_stride.get() or str(DEFAULT_RUN_CONFIG.optcuts.optcuts_frame_stride)),
            'optcuts_min_frame_long_edge': int(self.entry_optcuts_min_frame_long_edge.get() or str(DEFAULT_RUN_CONFIG.optcuts.optcuts_min_frame_long_edge)),
