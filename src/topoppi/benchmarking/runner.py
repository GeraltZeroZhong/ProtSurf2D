...
class BenchmarkRunner:
    ...
    def _run_single(self, pdb_path: str, chain_a: str, chain_b: str) -> Dict[str, object]:
        ...
        surf_gen = SurfaceGenerator(coords_a, config=self.config.surface)
        ...
        topo_mgr = TopologyManager(mesh_a, coords_b, config=self.config.topology)
        ...
        lscm_raw_quality = quality_block(patch_results["lscm"]["patches"], patch_gap=self.config.optcuts.patch_gap)
        lscm_optcuts_quality = quality_block(lscm_optcuts, patch_gap=self.config.optcuts.patch_gap)
        ...
        result = {
            ...
            "harmonic_raw": quality_block(patch_results["harmonic"]["patches"], patch_gap=self.config.optcuts.patch_gap),
            "spherical_raw": quality_block(patch_results["spherical"]["patches"], patch_gap=self.config.optcuts.patch_gap),
            "cylindrical_raw": quality_block(patch_results["cylindrical"]["patches"], patch_gap=self.config.optcuts.patch_gap),
            "topology_repair": {
